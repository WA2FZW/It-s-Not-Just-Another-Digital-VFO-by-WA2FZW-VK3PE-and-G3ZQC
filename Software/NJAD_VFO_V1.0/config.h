 ...
 *
 *	For the "BAND_SWITCH" and "MODE_SWITCH", there are 3 possible settings:
 *
...
#define BATTERY_PIN  35         		// It's built into the ESP32 board on this pin
#define BATTERY_ADJ 350         		// Fudge factor for A/D inaccuracy
...
#define	INCR_BUTTON AVAILABLE			// Yep!
#define	INCR_PIN 34						// Pin 34
...
/*
 *	If the PTT pin is enabled, we need to define it:
 */

#if ( PTT_LINE == AVAILABLE )		// PTT option installed?

	#define PTT_PIN	4				// Pin number

#endif


#define	XMIT_PIN	12				// For CAT control - Keys the transmitter
#define	FUNCN_PIN	39				// Function button
