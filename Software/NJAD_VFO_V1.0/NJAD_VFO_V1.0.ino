 ...
 *
 *		ESP32 VFO Hardware Manual		How to build it
 *		ESP32 VFO Hacker's Guide		How to program all the options
 *		ESP32 VFO CAT Control Manual	How to use the CAT control
 *		ESP32 VFO Operator's Maual		How it works
...
//	{ 28250000UL, 28250000UL, 28500000UL,  5500000UL, 28000000UL,  28500000UL, INC_100, BS_10, -1, MODE_USB },
	{ 50250000UL, 50250000UL, 50000000UL, 39102000UL, 50000000UL,  54000000UL, INC_100, BS_6M, +1, MODE_USB }
};
...
void setup()
{
	...
	pinMode ( FUNCN_PIN, INPUT );			// Function button
 ...
 */
	...
	if ( BATT_CHECK == NOT_AVAIL )					// Not installed?
		return voltage;								// Return last reading and bail out!
 ...
 */
	...
	if ( MODE_SWITCH != CAT_CONTROL )					// If can only change mode manually
	{
